...
export default props => {
    return (
        <div className="instalacao container-fluid">
            ...
            <p>Agora chegou a hora de instalarmos o seu arduíno, leve em conta que estou
                usando o SO windows 10, mas deixarei abaixo dicas
                para instalar em versões do windos anteriores.</p>
            <p>Conecte seu arduino em uma porta usb e espere alguns segundos, em seguida verifique
                em seu gerenciador de dispositivos se apareceu como na imagem.</p>
            <img src={driver}></img>
            ...
            <img src={porta}></img>
            <p>Se ocorreu tudo certo até aqui, é hora de testarmos o arduíno. Abra o programa, vá em arquivo,
                exemplo, basics e selecione Blink.</p>
            <img src={teste}></img>
            <p>Agora aperte no ícone com uma seta a direita no canto superior esquerdo ou simplesmente
                aperte Ctrl+U para carregar esse sketch no seu arduíno e aguarde um pouco</p>

...
<li>Agora é só executar e sua ide está quase pronta para funcionar.</li>
            ...
            <h4>Configuração</h4>
            <p>Agora chegou a hora de instalarmos o seu arduíno, leve em conta que estou usando o SO windows 
                10, mas deixarei abaixo dicas para instalar em versões do windos anteriores.
            </p>
            <p>Conecte seu arduino em uma porta usb e espere alguns segundos, em seguida verifique em seu gerenciador
            ...
            <p>Se ocorreu tudo certo até aqui, entre no seu programa do arduíno e verifique se a porta bate 
                com a qque apareceu no seu gerenciador de dispositivos, e sete a porta correta, como na imagem abaixo
            </p>
            <img src={porta}></img>
            <p>Se ocorreu tudo certo até aqui, é hora de testarmos o arduíno. Abra o programa, vá em arquivo, exemplo, basics e selecione Blink.</p>
            <img src={teste}></img>
        <p>Agora aperte no ícone com uma seta a direita no canto superior esquerdo ou simplesmente aperte Ctrl+U para carregar esse sketch no seu arduíno e aguarde um pouco</p>
